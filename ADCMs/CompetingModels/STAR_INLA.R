...
# #                               temp$INS), 4)
# temp
# writexl::write_xlsx(temp0, path = "./Result/STARx_INLAw_cv.xlsx")
# writexl::write_xlsx(Inla, path = "./Result/pred_STARx_INLAw_cv.xlsx")

# writexl::write_xlsx(temp0, path = "./Result/STARxz_INLAw_cv.xlsx")
# writexl::write_xlsx(Inla, path = "./Result/pred_STARxz_INLAw_cv.xlsx")
